...
class Volunteer {
    public:
        Volunteer(int id, const string &name);//constructor
...
class LimitedCollectorVolunteer: public CollectorVolunteer { // after he reaches to his maxOrders we should delete him
...
class LimitedDriverVolunteer: public DriverVolunteer {    // after he reaches to his maxOrders we should delete him
    ...
    public:
        ...
        void acceptOrder(const Order &order) override; // Reset distanceLeft to order's distance and decrease ordersLeft
        string toString() const override;
